...
# REST Framework settings - Updated for better development experience
REST_FRAMEWORK = {
...
# CSRF settings - Updated for better API compatibility
...
API_CONFIG = {
    'VERSION': '1.0.0',
    'NAME': 'Ubuntu Capital API',
    'DESCRIPTION': 'Loan management and credit scoring API',
}
